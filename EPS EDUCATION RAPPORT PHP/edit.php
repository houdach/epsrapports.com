...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container">
        ...
        <?php endif ?>
        <!-- Create Form -->
        <form action="http://localhost/EPS EDUCATION RAPPORT PHP/update.php"   method="POST">
          <input type="hidden" name="id"  value= "<?= $rapports['id']  ?>">
        ...
        <div class="col-6">
            ...
            <input type="date" class="form-control" name="date_1" id="date_1" placeholder="date_1" required value= "<?= $rapports['date_1']  ?>">
        ...
        <div class="col-6">
            ...
            <input type="date" class="form-control" name="date_2" id="date_2" placeholder="date_2" required value= "<?= $rapports['date_2']  ?>">
    ...
    <div class="form-row">
        ...
        <div class="col-2">
            ...
            <input type="text" class="form-control" id="ch_1_n" name="ch_1_n" placeholder="ch_1_n" required value= "<?= $rapports['ch_1_n']  ?>">
        ...
        <div class="col-4">
            ...
            <input type="text" class="form-control" name="ch_1_m" id="ch_1_m" placeholder="ch_1_m" required value= "<?= $rapports['ch_1_m']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-2">
            ...
            <input type="text" class="form-control" name="ch_2_n" id="ch_2_n" placeholder="ch_2_n" required value= "<?= $rapports['ch_2_n']  ?>">
        ...
        <div class="col-4">
            ...
            <input type="text" class="form-control" name="ch_2_m" id="ch_2_m" placeholder="ch_2_m" required value= "<?= $rapports['ch_2_m']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-2">
            ...
            <input type="text" class="form-control" name="ch_3_n" id="ch_3_n" placeholder="ch_3_n" required value= "<?= $rapports['ch_3_n']  ?>">
        ...
        <div class="col-4">
            ...
            <input type="text" class="form-control" name="ch_3_m" id="ch_3_m" placeholder="ch_3_m" required value= "<?= $rapports['ch_3_m']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-2">
            ...
            <input type="text" class="form-control" name="ch_4_n" id="ch_4_n" placeholder="ch_4_n" required value= "<?= $rapports['ch_4_n']  ?>">
        ...
        <div class="col-4">
            ...
            <input type="text" class="form-control" name="ch_4_m" id="ch_4_m" placeholder="ch_4_m" required value= "<?= $rapports['ch_4_m']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="ch_5_n" id="ch_5_n" placeholder="ch_5_n" required value= "<?= $rapports['ch_5_n']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="ch_6_n" id="ch_6_n" placeholder="ch_6_n" required value= "<?= $rapports['ch_6_n']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="ch_7_n" id="ch_7_n" placeholder="ch_7_n" required value= "<?= $rapports['ch_7_n']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="ch_8_n" id="ch_8_n" placeholder="ch_8_n" required value= "<?= $rapports['ch_8_n']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="ch_11_n" id="ch_11_n" placeholder="ch_11_n" required value= "<?= $rapports['ch_11_n']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="ch_9_n" id="ch_9_n" placeholder="ch_9_n" required value= "<?= $rapports['ch_9_n']  ?>">
   ...
   <tr>  
    ...
    <div class="form-row">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="ch_10_n" id="ch_10_n" placeholder="ch_10_n" required value= "<?= $rapports['ch_10_n']  ?>">
...
<a href="edit.php?id=<?= $rapports['id'] ?>" class="btn btn-outline-success">Enregistrez les modifications</a>
    <hr/>
